               ...
               <div class="custom-shadow-container position-sticky top-0">
                   <div>
                       <div class="head d-flex align-items-center gap-3">
                           ...
                           <h4 class="fw-bold fc-Darkgreay fs-6"> عدد الاسألة {{ questionNum }} من 20 </h4>
                       </div>
           ...
           <div class="col-xl-9 col-lg-9 col-12">
               <div class="custom-shadow-container">
                   ...
                   <div class="d-flex align-items-center justify-content-between">
                       ...
                       :disabled="!isStepValid" class="bg-green text-light py-2 px-5 rounded-5 mt-5">  انهاء 
                       </button>
                   </div>
               </div>
           </div>
...
const selectedStep1 = ref({
   ...
   selected8: undefined, 
   selected9: undefined, 
   selected10: undefined, 
   selected11: undefined, 
   selected12: undefined, 
   selected13: undefined, 
   selected14: undefined, 
   selected15: undefined, 
   selected16: undefined, 
   selected17: undefined, 
   selected18: undefined, 
   selected19: undefined, 
   selected20: undefined, 
})
...
const updatePercentage = computed(() => Math.round((questionNum.value / 20) * 100));
