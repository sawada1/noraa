<template>
    <div>
        <div class="container mh-full">

            <!-- login  -->
            <div v-if="checkForm == 1" class="form-container mb-4">
                ...
                <div class="inputs mt-3">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control form-control-l" placeholder=" أدخل بريدك الإلكتروني ">
                    </div>
                    <div class="mb-3">
                    ...
                    <button @click="checkForm = 4" class="btn fC-green forget"> هل نسيت كلمة السر؟ </button>

                    <div class="btns d-flex flex-column gap-3">
                        <button type="button" class="btn btn-success bg-green w-100"> تسجيل الدخول </button>
                        <button type="button" @click="checkForm = 3" class="btn bg-light-green fC-green  w-100"> تسجيل عبر رقم الجوال </button>
                    </div>
                    <div class="divide my-4"></div>
                    <div class="btns d-flex flex-column gap-3">
                        <button type="button" class="btn d-flex align-items-center justify-content-center gap-2 btn-outline-success w-100">
                        ...
                        <button type="button" class="btn btn-outline-success d-flex align-items-center gap-2 justify-content-center  w-100">
                    ...
                    <div class="sign d-flex align-items-center justify-content-center mt-4 gap-1">
                        ...
                        <button @click="checkForm = 2" class="btn fC-green p-0 m-0 forget"> سجل الان </button>
                    </div>
                </div>
            ...
            <!-- sign up  -->
            <div v-if="checkForm == 2" class="form-container mb-4">
                <NuxtImg src="/images/logoAuth.svg" width="150" height="150"></NuxtImg>
                <div class="text d-flex flex-column mt-4 align-items-center gap-3">
                    <h3>  إنشاء حساب  </h3>
                ...
                <div class="inputs mt-3">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control form-control-l" placeholder=" أدخل الاسم ">
                    </div>
                    <div class="mb-3">
                        <label class="form-label "> بريد إلكتروني </label>
                        <input type="email" class="form-control form-control-l" placeholder=" أدخل بريدك الإلكتروني ">
                    ...
                    <div class="btns d-flex flex-column gap-3">
                        <button type="button" class="btn btn-success bg-green w-100">  ابدأ الان  </button>
                    </div>
                   
                    <div class="sign d-flex align-items-center justify-content-center mt-4 gap-1">
                        <p class="m-0"> هل لديك حساب بالفعل؟ </p>
                        <button @click="checkForm = 1" class="btn fC-green p-0 m-0 forget">  تسجيل دخول  </button>
                    </div>
                </div>
            ...
            <div v-if="checkForm == 3" class="form-container mb-4">
                <NuxtImg src="/images/logoAuth.svg" width="150" height="150"></NuxtImg>
                <div class="text d-flex flex-column mt-4 align-items-center gap-3">
                    <h3> تسجيل عبر رقم الجوال </h3>
                    <p class="fc-grey"> مرحبًا بك مرة أخرى! الرجاءادخل التفاصيل. </p>
                </div>
                <div class="inputs mt-3">
                    <div class="mb-3">
            ...
            <div v-if="checkForm == 4" class="form-container mb-4">
                <NuxtImg src="/images/logoAuth.svg" width="150" height="150"></NuxtImg>
                <div class="text d-flex flex-column mt-4 align-items-center gap-3">
                ...
                <div class="inputs mt-3">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control form-control-l" placeholder=" أدخل بريد إلكتروني ">
                    </div>
                 

                    <div class="btns d-flex flex-column gap-3">
                        <button type="button" class="btn btn-success bg-green w-100"> ارسال </button>
                    </div>
